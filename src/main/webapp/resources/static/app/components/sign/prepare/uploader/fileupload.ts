...
export class FileUpload implements OnInit,AfterContentInit {
    ...
    constructor(private sanitizer: DomSanitizer, private prepareFormDataService: PrepareFormDataService){}
    ...
    upload() {
        ...
        for(let i = 0; i < this.files.length; i++) {
            formData.append(this.name, this.files[i], this.files[i].name);
             console.log(this.name, this.files[i], this.files[i].name);
        }
...
@NgModule({
    imports: [CommonModule,SharedModuleUp,ButtonModule,ProgressBarModule,MessagesModule],
    exports: [FileUpload,SharedModuleUp,ButtonModule,ProgressBarModule,MessagesModule],
