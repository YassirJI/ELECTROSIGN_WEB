...
export class FileUploadComponent implements OnInit,AfterContentInit {
    ...
    constructor(private sanitizer: DomSanitizer, private preparePackageFormDataService: PreparePackageFormDataService){}
    ...
    setUploadedPackageDocumentsList():void {
        this.preparePackageFormDataService.setUploadedPackageDocuments(this.files);
    }
    ...
    upload() {
        ...
        if(this.hasFiles()) {
            this.setUploadedPackageDocumentsList();
        }
